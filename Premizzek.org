...
* Class
  ...
  | ! |     HP | HD | Class Name      | BAB | Skills | Fort | Ref | Will | Levels |
  |---+--------+----+-----------------+-----+--------+------+-----+------+--------|
  |   |      7 | d6 | Empyereal Sorc. |   0 |      2 |    0 |   0 |    2 |      1 |
  |   |      2 | d6 | Gunslinger      |   0 |      2 |    0 |   0 |    2 |      1 |
  |---+--------+----+-----------------+-----+--------+------+-----+------+--------|
  |   | Totals |    |                 |     |        |      |     |      |        |
  |---+--------+----+-----------------+-----+--------+------+-----+------+--------|
  | # |      9 |    |                 |   0 |      4 |    0 |   0 |    4 |      2 |
...
* Spells
  ...
  |            |     0 | Daze               |             |       8 |
  |            |     0 | Ghost Sound        |             |       8 |
  |            |     0 | Haunted Fey Aspect |             |       8 |
  |            |     0 | Bleed              |             |       8 |
  |            |     0 | Disrupt Undead     |             |       8 |
  |            |     0 | Touch of Fatigue   |             |       8 |
  |            |     0 | Jolt               |             |       8 |
  |            |     0 | Mage hand          |             |       8 |
  |            |     0 | Mending            |             |       8 |
  |            |     0 | Message            |             |       8 |
  |            |     0 | Open/Close         |             |       8 |
  |            |     0 | Root               |             |       8 |
  |            |     0 | Scrivener's Chant  |             |       8 |
  |            |     0 | Prestidigitation   |             |       8 |
  |            |     0 | Arcane Mark        |             |       8 |
  |            |     1 | Read Magic         |             |       9 |
  |------------+-------+--------------------+-------------+---------|
