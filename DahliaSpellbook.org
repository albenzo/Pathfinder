...
** Level 5
   Shadow Evocation : Varies : Varies : Mimics evocation spell below 5th level, but only 20% real
** Level 6
   Shadow Walk : Touch : 1 hr/lvl : Take creature per level and travel on border of the shadow plane.
** Level 7
   Greater Shadow Conjuration : Varies : Varies : Mimics conjuration below 7th level but only 60% real
* Learned Spells
** Level 0
...
** Level 1
   ...
   Obscuring Mist (Mythic) : 20 rad on caster : 1 min/lvl : Fog surrounds you
...
** Level 4
   ...
   (Mythic Aug) Detect Scrying : 40ft rad : 24 hrs : Detect any sensors around you. Can find visual image and picture with cl check
...
** Level 5
   ...
   (Mythic Aug) Dominate Person : 25+5ft/2lvl : 1 day/lvl : Will save or becomes under the control of caster 
...
** Level 6
   Cloak of Dreams : 5ft rad : Anyone within 5ft make a will save or fall asleep
   Dust Form : self : Turn into dust to become incorporeal
   Greater Dispel Magic : 100+10/lvl : Like dispel magic but better
   Swarm Skin : self : Turn into a bunch of swarms
** Level 7
   Chain Lightening : 400+40ft/lvl : 1 + 1 2ndary trget/lvl : 1d6/cl lvl and secondary target per cl lvl. Reflex is 2 lower.
   Phase Door : Touch : 1 use/2lvl : Create a passage 5x8ft and 10+5ft/3lvl. Can set triggers
   (Mythic) Plane Shift : Tuning Fork : Touch (8 max) : Shift to another plane. Cannot be accurate and requires tuning fork.
   Insanity : 100+10ft/lvl : 1 : Target is permanently confused
** Level 8
   Demand : : Acts as sending but the message can contain a suggestion. Must be 25 words or less. Subject can reply
   Mind Blank : 25+5ft/2lvl : 24hr : Protected from all spells that gather info via divination. +8 vs mind affecting
* Spells I WANT
** Level 1
